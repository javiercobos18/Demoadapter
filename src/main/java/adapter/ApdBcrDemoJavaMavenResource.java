...
@Path("/resource")
public class ApdBcrDemoJavaMavenResource {
	/*
	...
	static Logger logger = Logger.getLogger(ApdBcrDemoJavaMavenResource.class.getName());
	...
	/*
	 * Path for method:
	 * "<server address>/mfp/api/adapters/apdBcrDemoJavaMaven/resource"
	 */
	...
	/*
	 * Path for method:
	 * "<server address>/mfp/api/adapters/apdBcrDemoJavaMaven/resource/greet?name={name}"
	 */
	...
	/*
	 * Path for method:
	 * "<server address>/mfp/api/adapters/apdBcrDemoJavaMaven/resource/{path}/"
	 */
	...
	/*
	 * Path for method:
	 * "<server address>/mfp/api/adapters/apdBcrDemoJavaMaven/resource/prop"
	 */
	...
	/*
	 * Path for method:
	 * "<server address>/mfp/api/adapters/apdBcrDemoJavaMaven/resource/unprotected"
	 */
	...
	/*
	 * Path for method:
	 * "<server address>/mfp/api/adapters/apdBcrDemoJavaMaven/resource/protected"
	 */
